...
export default function StudentLayout({ children, userName = "Estudiante", userInitials = "ES" }: StudentLayoutProps) {
  ...
  const menuItems = [
    { href: "/estudiante/mis-cursos", label: "Mis Cursos", icon: "📚" },
    { href: "/estudiante/ofertas-laborales", label: "Ofertas Laborales", icon: "💼" },
    { href: "/estudiante/perfil-habilidades", label: "Mi Perfil", icon: "👤" },
  ];
        ...
        <div className="px-4 md:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden p-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-white"
              title="Abrir menú"
            >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <div className="hidden sm:flex items-center gap-2">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-blue-100 rounded-full flex items-center justify-center">
                <span className="text-blue-600 font-bold text-xs md:text-sm">{userInitials}</span>
              </div>

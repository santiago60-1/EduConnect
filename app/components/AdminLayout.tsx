...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    { href: "/admin", label: "Analítica", icon: "📊" },
    { href: "/admin/profesores", label: "Profesores", icon: "👥" },
    { href: "/admin/competencias", label: "Competencias", icon: "📚" },
    { href: "/admin/empleos", label: "Empleos", icon: "👨‍💼" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="px-4 md:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden p-2 bg-orange-600 hover:bg-orange-700 rounded-lg transition-colors text-white"
              title="Abrir menú"
            >
            ...
            <h1 className="text-sm md:text-xl font-bold text-gray-900 hidden sm:block">EduConnect - Panel de Administración</h1>
          </div>
          <button
      ...
      >
        <h2 className="text-base md:text-lg font-bold text-gray-900 mb-6">Panel de Administración</h2>
